...
<script src="https://cdn.tailwindcss.com"></script>
  ...
  <meta name="description" content="Web site created by David-Mainoo using create-react-app">
  ...
  <link href="./MZAR_files/css2" rel="stylesheet">
  ...
  <style data-styled="active" data-styled-version="5.3.3">
    * {
    ...
    .gOwAeT nav button {
      box-shadow: 0 1px 6px -3px hsl(208, 11%, 55%);
    }
    ...
    .gEYiuS article {
      ...
      box-shadow: 0 0 3px hsl(208, 11%, 55%);
    ...
    .gEYiuS .cta {
      padding: 2rem 4% 3rem;
      box-shadow: 0 -0px 4px -1px hsl(208, 11%, 55%);
      display: grid;
      -webkit-align-items: center;
      -webkit-box-align: center;
      -ms-flex-align: center;
    ...
    .gEYiuS .cta button {
      box-shadow: 0 1px 4px -0.4px hsl(208, 11%, 55%);
    }
    ...
    @media screen and (min-width:1000px) {
      ...
      .gEYiuS article:nth-child(even) {
        grid-template-areas: "txt pic";
      }

      .gEYiuS article:nth-child(even) div {
        margin: 0 auto 0 0;
      }
    }
    ...
    .iggNUH .navItemWithIcon .icon {
      max-width: 1em;
    }

    .iggNUH .navItemWithIcon .icon-location {
      min-width: 100%;
      padding: 0;
      padding-top: 4px;
      margin: 0;
    ...
    .iggNUH .social-icons .social-icon {
    ...
    .iggNUH .social-icons .social-icon:hover {
...
<body>
  <div id="root">
    <div class="appContainer">
      <header class="sc-bdvvtL gOwAeT">
        <nav>
          <h1 class="self-center text-2xl font-semibold">MZAR</h1><button class="sc-gsDKAQ owVVI"><a href="/logout"><i class="bi bi-box-arrow-right"></i> Logout</a></button>
        </nav>
        ...
        <section class="headerContent">
          <article>
            <h1 class="font-semibold">Welcome to our website</h1>
            <p>We provide the services you may need, with a website-based system.</p><button class="sc-dkPtRN fKCCol">
              <a href="/contact">My Contact</a></button>
          </article><svg viewBox="0 0 1035 739" class="illustrationMockup" xmlns="http://www.w3.org/2000/svg">
            <defs>
              ...
              <rect id="i" width="320" height="512" rx="17.067"></rect>
            ...
            <g fill="none" fill-rule="evenodd">
              <g transform="translate(10 10)">
                ...
                <use fill="#000" filter="url(#c)" href="#d"></use>
                <use fill="#00252E" href="#d"></use>
                <rect fill="#E1E8EE" x="72" y="20" width="200" height="24" rx="5"></rect>
                <g transform="translate(864 22)" fill="#D8D8D8">
                  <rect width="32" height="4" rx="2"></rect>
                  <rect y="8" width="32" height="4" rx="2"></rect>
                  <rect y="16" width="32" height="4" rx="2"></rect>
                </g>
                <g transform="translate(72 138)">
                  <circle fill="url(#e)" cx="48" cy="48" r="48"></circle>
                  <g transform="translate(152 12)" fill="#E1E8EE">
                    <rect width="115" height="16" rx="3"></rect>
                    <rect y="32" width="400" height="8" rx="3"></rect>
                    <rect y="48" width="366.667" height="8" rx="3"></rect>
                    <rect y="64" width="333.333" height="8" rx="3"></rect>
                  </g>
                ...
                <g transform="translate(72 274)">
                  <circle fill="url(#f)" cx="45" cy="45" r="45"></circle>
                ...
                <g transform="translate(72 417)">
                  <circle fill="url(#g)" cx="45" cy="45" r="45"></circle>
                  <g transform="translate(149 9)" fill="#E1E8EE">
                    <rect width="115" height="16" rx="3"></rect>
                    <rect y="32" width="400" height="8" rx="3"></rect>
                    <rect y="48" width="366.667" height="8" rx="3"></rect>
              ...
              <g transform="translate(706 218)">
                <use fill="#000" filter="url(#h)" href="#i"></use>
                <use fill="#FFF" href="#i"></use>
              </g>
              <g transform="translate(706 218)">
                <use fill="#000" filter="url(#j)" href="#k"></use>
                <use fill="#00252E" href="#k"></use>
              </g>
              <g transform="translate(738.133 236.773)">
                <rect fill="#E1E8EE" width="104" height="20.48" rx="4.267"></rect>
                <g transform="translate(226.427 1.707)" fill="#D8D8D8">
                  <rect width="27.307" height="3.413" rx="1.707"></rect>
                  <rect y="6.827" width="27.307" height="3.413" rx="1.707"></rect>
                  <rect y="13.653" width="27.307" height="3.413" rx="1.707"></rect>
                </g>
              </g>
              <g transform="translate(738 326)">
                <circle fill="url(#e)" cx="15" cy="15" r="15"></circle>
                <g transform="translate(46 3)" fill="#E1E8EE">
                  <rect width="57.5" height="5.333" rx=".92"></rect>
                  <rect y="10.667" width="200" height="2.667" rx=".92"></rect>
                  <rect y="16" width="183.333" height="2.667" rx=".92"></rect>
                  <rect y="21.333" width="166.667" height="2.667" rx=".92"></rect>
                </g>
              </g>
              ...
              <g transform="translate(738 372)">
                ...
                <circle fill="url(#f)" cx="15" cy="15" r="15"></circle>
              </g>
              ...
              <g transform="translate(738 418)">
                ...
                <circle fill="url(#g)" cx="15" cy="15" r="15"></circle>
              </g>
      ...
      <section class="sc-hKwDye gEYiuS">
        <article><svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1023.46 837.84">
            <defs>
              ...
              <lineargradient id="b" x1="569.83" y1="551.49" x2="569.83" y2="380.82" href="#a"></lineargradient>
              <lineargradient id="c" x1="171.5" y1="319.2" x2="171.5" y2="319.02" href="#a"></lineargradient>
              <lineargradient id="d" x1="228.01" y1="853.75" x2="228.01" y2="250.26" href="#a"></lineargradient>
              <lineargradient id="e" x1="944.05" y1="849.94" x2="944.05" y2="268.42" href="#a"></lineargradient>
            </defs>
            <ellipse cx="176" cy="807.85" rx="176" ry="29.99" fill="#00c7fa" opacity=".1"></ellipse>
            <ellipse cx="847.47" cy="800.75" rx="176" ry="29.99" fill="#00c7fa" opacity=".1"></ellipse>
            <path
              ...
              fill="#00c7fa" opacity=".1"></path>
            <g opacity=".7">
              <path fill="#f6f7f9" d="M258.54 367.11H449.5v106.71H258.54z"></path>
              <circle cx="294.49" cy="414.48" r="19.88" fill="#00c7fa" opacity=".2"></circle>
              <path fill="#00c7fa"
                ...
                opacity=".2"></path>
              <path fill="#f6f7f9" d="M419.31 72.2h190.96v106.71H419.31z"></path>
              <circle cx="455.27" cy="119.57" r="19.88" fill="#00c7fa" opacity=".2"></circle>
              <path fill="#00c7fa"
                ...
                opacity=".2"></path>
              <path fill="#f6f7f9" d="M482.87 251.36h190.96v106.71H482.87z"></path>
              <circle cx="518.82" cy="298.74" r="19.88" fill="#00c7fa" opacity=".2"></circle>
              <path fill="#00c7fa"
            ...
            <path fill="url(#a)" d="M191.88 135.71h321.11v181.44H191.88z"></path>
            <path fill="#f6f7f9" d="M194.15 137.96h316.6v176.93h-316.6z"></path>
            <circle cx="253.75" cy="216.51" r="32.96" fill="#00c7fa" opacity=".2"></circle>
            <path fill="#00c7fa"
              ...
              opacity=".2"></path>
            <path fill="#00c7fa" d="M430.79 279.78h39.74v17.46h-39.74z"></path>
            <path fill="url(#b)" d="M417.12 380.82h305.42v170.67H417.12z"></path>
            <path fill="#f6f7f9" d="M419.23 381.99h301.2v168.32h-301.2z"></path>
            <circle cx="475.94" cy="456.72" r="31.36" fill="#00c7fa" opacity=".2"></circle>
            <path fill="#00c7fa"
              ...
              opacity=".2"></path>
            <path fill="#00c7fa" d="M644.36 516.91h37.81v16.61h-37.81z" opacity=".5"></path>
            ...
            <path
              ...
              transform="translate(-88.27 -31.08)" fill="url(#d)"></path>
            <path
            ...
            <path
              ...
              opacity=".1"></path>
            <path d="M156.73 275.14a33.38 33.38 0 1 1-12.56-26.08 33.38 33.38 0 0 1 12.56 26.08z" fill="#efb7b9"></path>
            <path
            ...
            <path
              ...
              fill="#e1e7ef"></path>
            <circle cx="129.73" cy="329.32" r="1.9" fill="#67647e"></circle>
            <circle cx="130.61" cy="346.65" r="1.9" fill="#67647e"></circle>
            <circle cx="132.5" cy="374.72" r="1.9" fill="#67647e"></circle>
            <circle cx="135.65" cy="404.94" r="1.9" fill="#67647e"></circle>
            <circle cx="137.54" cy="433.33" r="1.9" fill="#67647e"></circle>
            <circle cx="139.44" cy="463.56" r="1.9" fill="#67647e"></circle>
            <circle cx="138.68" cy="493.47" r="1.9" fill="#67647e"></circle>
            <path
            ...
            <path
              ...
              opacity=".1"></path>
            <path d="M113.05 337.5l14.3-10.24s-20.91-12.35-23.4-10.62-4.2 18.21-4.2 18.21z" fill="#e1e7ef"></path>
            <path d="M113.05 337.5l14.3-10.24s-20.91-12.35-23.4-10.62-4.2 18.21-4.2 18.21z" opacity=".03"></path>
            <path
              ...
              fill="#67647e"></path>
            <path d="M149.02 331.81l-17.81-6.6s22.69-24.84 25.51-11.06z" opacity=".1"></path>
            <path d="M149.02 330.92l-17.81-6.59s22.69-24.85 25.51-11.07z" fill="#e1e7ef"></path>
            <path d="M149.02 330.92l-17.81-6.59s22.69-24.85 25.51-11.07z" opacity=".03"></path>
            <path d="M148.45 309.81a1 1 0 0 1 .73.15z" opacity=".1"></path>
            <path
            ...
            <path
              ...
              opacity=".1"></path>
            <ellipse cx="968.23" cy="761.73" rx="41" ry="5.63" fill="#00c7fa" opacity=".1"></ellipse>
            <ellipse cx="646.82" cy="814.56" rx="29.14" ry="4" fill="#00c7fa" opacity=".1"></ellipse>
            <ellipse cx="386.08" cy="784.91" rx="29.14" ry="4" fill="#00c7fa" opacity=".1"></ellipse>
            <path
            ...
            <path
              ...
              transform="translate(-88.27 -31.08)" fill="url(#e)"></path>
            <path fill="#a27772" d="M835.72 774.95l-1.4 26.34-8.86-2.21-1.87-10.96 12.13-13.17z"></path>
            <path opacity=".1" d="M835.72 774.95l-1.4 26.34-8.86-2.21-1.87-10.96 12.13-13.17z"></path>
            <path
            ...
            <path
              ...
              fill="#cc818c"></path>
            <path d="M813.32 454.12h77.64c-2.17-5.87-3.6-10.14-3.6-10.14l-73.44 4.2z" opacity=".1"></path>
            <path
            ...
            <path
              ...
              fill="#cc818c"></path>
            <circle cx="855.7" cy="297.09" r="30.08" opacity=".1"></circle>
            <circle cx="855.7" cy="296.39" r="30.08" fill="#cc818c"></circle>
            ...
            <path d="M874.33 359.25l-9-17.58s13.24-5.34 14.2-11.54 12.68 7.27 10.14 11.72-15.34 17.4-15.34 17.4z"
              fill="#67647e"></path>
            <path d="M800.32 404.65l50 67.19s-18.42 10-43.84-7.93l-11-13.05-31.25-52.7z" fill="#f6f8fb"></path>
            ...
            <path d="M841.81 356.37l17.24-14s-11.8-6.4-13.21-11.86-10.85 2.59-9.89 7.49 5.86 18.37 5.86 18.37z"
              fill="#67647e"></path>
            <circle cx="859.72" cy="354.09" r="1.37" opacity=".1"></circle>
            <circle cx="859.72" cy="361.71" r="1.37" opacity=".1"></circle>
            <circle cx="859.72" cy="369.32" r="1.37" opacity=".1"></circle>
            <g opacity=".1">
              <path
          ...
          <div>
            <h3 class="font-semibold">Find products</h3>
            <p>Please look for a product that you think is good and we only recommend it here.</p><button
              class="sc-eCImPb ClkFP"><a href="/order">order</a></button>
          </div>
        </article>
        <article><svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1125.12 800.94">
            <defs>
              ...
              <lineargradient id="b" x1="1069.38" y1="751.23" x2="1069.38" y2="686.58" href="#a"></lineargradient>
            </defs>
            <path
            ...
            <path
              ...
              opacity=".1"></path>
            <ellipse cx="237.65" cy="719.04" rx="25.44" ry="3.49" fill="#00c7fa" opacity=".1"></ellipse>
            <ellipse cx="140.21" cy="728.92" rx="25.44" ry="3.49" fill="#00c7fa" opacity=".1"></ellipse>
            <ellipse cx="25.44" cy="715.54" rx="25.44" ry="3.49" fill="#00c7fa" opacity=".1"></ellipse>
            <ellipse cx="179.21" cy="757.05" rx="18.08" ry="2.48" fill="#00c7fa" opacity=".1"></ellipse>
            <ellipse cx="78.08" cy="754.57" rx="18.08" ry="2.48" fill="#00c7fa" opacity=".1"></ellipse>
            <path
            ...
            <path
              ...
              fill="none" stroke="#565987" stroke-miterlimit="10"></path>
            <path
            ...
            <path
              ...
              transform="translate(-37.44 -49.53)" fill="url(#a)"></path>
            <path
              ...
              transform="translate(-37.44 -49.53)" fill="url(#b)"></path>
            <path
            ...
            <path
              ...
              fill="#d5838e"></path>
            <path fill="#ffccd0" d="M376.42 679.95h19.81v17.06h-19.81z"></path>
            <path
            ...
            <path
              ...
              opacity=".1"></path>
            <path d="M794.04 446.22s5 21 16 32.09l4.41-9.58-5.51-17.47z" fill="#f26383"></path>
            <path d="M808.9 451.26l-14.86-5s5 21 16 32.09" opacity=".1"></path>
            <path
            ...
            <path
              ...
              fill="#ffc1c7"></path>
            <path d="M813.12 469.14l-5.48 3.1a33.59 33.59 0 0 0-14.56-24.17l1.51-1.13 4.41-1.65z" opacity=".1"></path>
            <path
            ...
            <path
              ...
              opacity=".1"></path>
            <path d="M661.42 324.23a33 33 0 1 1-33-33 32.82 32.82 0 0 1 33 33z" fill="#cf6f80"></path>
            <path
            ...
            <path
              ...
              fill="#575a89"></path>
            <path d="M684.26 411.64s25.31 2.75 26.41 9.08-26.41-9.08-26.41-9.08z" opacity=".1"></path>
            <path
            ...
            <path fill="#f8bda5" d="M571.45 780.34l-9.91-.83-36.04-293.03 10.64-.32-.46 1.69 35.77 292.49z"></path>
            <path fill="#ffceb4"
              d="M619.88 487.03l-36.33 290.56-6.8 1.54-5.3 1.21.27-53.65 31.92-238.56.63-.05 15.61-1.05z"></path>
            <path fill="#f8bda5"
            ...
            <path fill="#ffceb4" d="M702.97 665.88l-.83 19.05-28.06-196.8-.46-2.23 2.39-.25 26.96 180.23z"></path>
            <path fill="#f8bda5" d="M712.33 576.45l.82 121.34-4.6-.17-9.71-.38 3.86-212.41 7.4.92 3.6.45-1.37 90.25z">
            </path>
            <path fill="#ffceb4" d="M712.33 576.45l.82 121.34-4.6-.17 1.55-211.87 3.6.45-1.37 90.25z"></path>
            <path fill="#f8bda5"
              d="M397.28 484l.55-8.25 47.32.27 142.26-2.2 109.78 6.05 69.89 1.38.83 7.7-179.68 3.31L397.28 484z"></path>
            <path fill="#ffceb4" d="M397.83 475.75l140.32 6.05 228.93-.55-171.14-10.46-198.11 4.96z"></path>
            <path
              ...
              opacity=".1"></path>
            <path d="M381.32 285.89a42.37 42.37 0 1 1-4.41-18.82 42.41 42.41 0 0 1 4.41 18.82z" fill="#ffccd0"></path>
            <path
            ...
            <path
              d="M583.04 466.62c0 5.57-9.74 11.14-21.76 11.14s-21.72-5.57-21.72-11.14 9.74-9 21.75-9 21.73 3.43 21.73 9z"
              opacity=".1"></path>
            <ellipse cx="561.29" cy="466.62" rx="21.75" ry="10.08" fill="#e8eaf2"></ellipse>
            <ellipse cx="561.35" cy="467" rx="12.98" ry="5.23" opacity=".05"></ellipse>
            <path
            ...
            <path d="M540.3 446.65v2.82a19.76 19.76 0 0 0 19.76 19.76h2.5a19.76 19.76 0 0 0 19.71-19.76v-2.82z"
              fill="#f1cec8"></path>
            <ellipse cx="561.19" cy="446.03" rx="21.09" ry="6" fill="#f6e2df"></ellipse>
            <ellipse cx="561.29" cy="445.65" rx="19.99" ry="5.42" opacity=".1"></ellipse>
            <ellipse cx="561.35" cy="445.45" rx="19.53" ry="5.42" fill="#fdf9f9"></ellipse>
            <path
              ...
              fill="#42312e" opacity=".3"></path>
            <circle cx="545.89" cy="446.25" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="547.9" cy="442.39" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="550.67" cy="444.14" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="548.87" cy="441.64" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="558.99" cy="443.51" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="550.24" cy="443.09" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="549.22" cy="442.97" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="551.22" cy="445.05" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="566.42" cy="443.44" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="570.48" cy="444.23" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="569.35" cy="447.72" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="570.9" cy="446.55" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="566.34" cy="447.99" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="565.32" cy="443.41" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="561.94" cy="447.38" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="568.05" cy="444.34" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="565.08" cy="448.26" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="552.83" cy="447.72" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="569.7" cy="445.25" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="576.07" cy="444.78" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="574.24" cy="443.17" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="567.85" cy="442.74" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="555.62" cy="445.25" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="572.44" cy="444.68" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="566.54" cy="442.43" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="571.57" cy="443.38" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="568.53" cy="441.34" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="566.34" cy="440.99" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="556.34" cy="441.97" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="558.54" cy="442.23" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="552.98" cy="444.23" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="564.18" cy="444.34" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="565.47" cy="444.64" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="558.09" cy="444.99" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="561.35" cy="445.34" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="557.84" cy="442.85" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="565.22" cy="445.34" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="564.11" cy="445.54" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="547.07" cy="442.43" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="553.82" cy="443.17" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="551.49" cy="441.64" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="550.56" cy="445.32" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="551.66" cy="442.87" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="545.25" cy="443.71" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="573.01" cy="442.87" r=".2" fill="#42312e" opacity=".3"></circle>
            <circle cx="575.31" cy="442.54" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="577.24" cy="445.45" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="575.8" cy="443.99" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="576.42" cy="445.89" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="577.24" cy="444.41" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="575.03" cy="444.14" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="578.11" cy="444.14" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="552.35" cy="443.57" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="556.23" cy="440.91" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="560.99" cy="446.67" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="555" cy="440.87" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="553.33" cy="441.1" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="560.68" cy="442.62" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="545.98" cy="444.5" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="548.4" cy="446.97" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="557.62" cy="448.18" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="555.51" cy="446.97" r=".27" fill="#42312e" opacity=".3"></circle>
            <circle cx="561.88" cy="448.45" r=".27" fill="#42312e" opacity=".3"></circle>
            <path
            ...
            <path
              ...
              opacity=".1"></path>
            <path d="M320.56 590.21l-.13-1.56c.45-5.18.13 1.56.13 1.56z" fill="#e4aab4"></path>
            <path
            ...
            <path
              ...
              opacity=".1"></path>
            <path d="M907.96 344.04a36 36 0 1 1-36-35.95 35.91 35.91 0 0 1 36 35.95z" fill="#ffc1c7"></path>
            <path
            ...
            <path d="M479.27 615.25s30.77-.92 23.43 2.38-28.11 3-28.11 3zM605.84 680.83s14.31-2.2 18 .18-18-.18-18-.18z"
              opacity=".1"></path>
            <ellipse cx="1031.83" cy="694.45" rx="40.86" ry="5.61" fill="#00c7fa" opacity=".1"></ellipse>
            <path
            ...
            <path
              d="M698.4 475.86c0 2.81-8.83 6.12-19.72 6.12s-19.72-3.31-19.72-6.12 8.83-4.08 19.72-4.08 19.72 1.26 19.72 4.08z"
              opacity=".1"></path>
            <ellipse cx="678.68" cy="475.86" rx="19.72" ry="5.1" fill="#e8eaf2"></ellipse>
            <ellipse cx="678.68" cy="475.86" rx="11.15" ry="2.88" opacity=".1"></ellipse>
            <path
            ...
            <path
              ...
              fill="#f1cec8"></path>
            <ellipse cx="678.48" cy="465.04" rx="10.05" ry="1.63" opacity=".1"></ellipse>
            <ellipse cx="678.48" cy="465.23" rx="10.05" ry="1.63" fill="#42312e"></ellipse>
            <path
            ...
            <path
              ...
              fill="#f2dcdc"></path>
            <path d="M668.26 468.27s.85.88 3.24 1a8.86 8.86 0 0 1-3.41-.28z" opacity=".1"></path>
            <path fill="#e4aab4" d="M438.86 614.08l36.99-.11-12.11 19.32-23.85 12.09-1.03-31.3z"></path>
          </svg>
          <div>
            <h3 class="font-semibold">Find products</h3>
            <p>Please look for a product that you think is good and we only recommend it here.</p><button
        ...
        <article><svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1077.87 813.02">
            <defs>
              <lineargradient id="a" x1="975.77" y1="484.92" x2="975.77" y2="87.89"
                gradientTransform="translate(-77.03)" gradientUnits="userSpaceOnUse">
                <stop offset="0" stop-color="gray" stop-opacity=".25"></stop>
                <stop offset=".54" stop-color="gray" stop-opacity=".12"></stop>
                <stop offset="1" stop-color="gray" stop-opacity=".1"></stop>
              </lineargradient>
              <lineargradient id="b" x1="649.11" y1="832.85" x2="649.11" y2="382.11" href="#a"></lineargradient>
            </defs>
            <path
              ...
              fill="#00c7fa" opacity=".1"></path>
            <ellipse cx="489.56" cy="532.53" rx="226.98" ry="10.36" fill="#00c7fa" opacity=".1"></ellipse>
            <path
            ...
            <path
              ...
              fill="#fff"></path>
            <ellipse cx="979.99" cy="403.16" rx="14.27" ry="4.72" fill="#00c7fa" opacity=".1"></ellipse>
            <ellipse cx="178.55" cy="651.82" rx="84.04" ry="13.79" fill="#00c7fa" opacity=".1"></ellipse>
            <g opacity=".1">
              <path
            ...
            <g opacity=".2" fill="#00c7fa">
              <rect x="96.06" y="311.6" width="207.7" height="12.66" rx="5.67" ry="5.67"></rect>
              <rect x="96.06" y="368.18" width="207.7" height="12.66" rx="5.67" ry="5.67"></rect>
              <rect x="96.06" y="396.47" width="174.18" height="12.66" rx="5.67" ry="5.67"></rect>
              <rect x="96.06" y="339.89" width="90.06" height="12.66" rx="5.67" ry="5.67"></rect>
            </g>
            <path
            ...
            <path
              ...
              fill="#985c7e"></path>
            <path d="M153.7 449.13s3.84 17.94 10.22 22.83z" opacity=".1"></path>
            <g opacity=".1">
              <path
            ...
            <path
              ...
              fill="#00c7fa"></path>
            <ellipse cx="495.06" cy="797.52" rx="26.93" ry="4.55" fill="#00c7fa" opacity=".1"></ellipse>
            <path
              ...
              fill="#00c7fa"></path>
            <ellipse cx="793.17" cy="764.92" rx="26.93" ry="4.55" fill="#00c7fa" opacity=".1"></ellipse>
            <ellipse cx="848.09" cy="436.83" rx="77.55" ry="12.72" fill="#00c7fa" opacity=".1"></ellipse>
            <path
              ...
              transform="translate(-61.06 -43.49)" fill="url(#a)"></path>
            <path
            ...
            <path
              ...
              fill="#ff748f"></path>
            <circle cx="879.75" cy="421.07" r=".55" fill="#575988"></circle>
            <circle cx="875.09" cy="425.43" r=".55" fill="#575988"></circle>
            <circle cx="870.35" cy="429.35" r=".55" fill="#575988"></circle>
            <circle cx="872.8" cy="427.6" r=".55" fill="#575988"></circle>
            <circle cx="877.52" cy="423.11" r=".55" fill="#575988"></circle>
            <path
            ...
            <path
              ...
              opacity=".1"></path>
            <path d="M908.11 80.66a23.65 23.65 0 1 1-23.65-23.65 23.64 23.64 0 0 1 23.65 23.65z" fill="#cc818c"></path>
            <path
            ...
            <path
              ...
              fill="#ff748f"></path>
            <circle cx="823.66" cy="414.31" r=".55" fill="#575988"></circle>
            <circle cx="809.68" cy="420.38" r=".55" fill="#575988"></circle>
            <circle cx="802.48" cy="422.57" r=".55" fill="#575988"></circle>
            <circle cx="813.35" cy="419.22" r=".55" fill="#575988"></circle>
            <circle cx="806.07" cy="421.48" r=".55" fill="#575988"></circle>
            <circle cx="817.06" cy="417.5" r=".55" fill="#575988"></circle>
            <circle cx="820.73" cy="415.91" r=".55" fill="#575988"></circle>
            <path
            ...
            <path
              ...
              fill="#575988" opacity=".5"></path>
            <path d="M890.87 238.35l-3.5 3.29-8.7-11.13a29.63 29.63 0 0 0 2.67-1.68z" opacity=".1"></path>
            <path
            ...
            <path
              ...
              opacity=".1"></path>
            <path d="M852.53 270.08l10.55 27.82s1.49-17.9-1.66-23.26a9.29 9.29 0 0 0-8.89-4.56z" opacity=".05"></path>
            <g opacity=".1">
              <path
            ...
            <path
              ...
              fill="#fff"></path>
            <g opacity=".2" fill="#00c7fa">
              <rect x="611.18" y="104.02" width="191.66" height="11.68" rx="5.67" ry="5.67"></rect>
              <rect x="611.18" y="156.23" width="158.15" height="11.68" rx="5.67" ry="5.67"></rect>
              <rect x="611.18" y="130.13" width="113.85" height="11.68" rx="5.67" ry="5.67"></rect>
            </g>
            <path
            ...
            <ellipse cx="71.71" cy="612.01" rx="37.28" ry="5.72" fill="#00c7fa" opacity=".1"></ellipse>
            <path
            ...
            <ellipse cx="645.79" cy="789.35" rx="84.04" ry="13.79" fill="#00c7fa" opacity=".1"></ellipse>
            <g opacity=".1">
              <path
            ...
            <path
              ...
              fill="#fff"></path>
            <g opacity=".2" fill="#00c7fa">
              <rect x="508.85" y="463.22" width="207.7" height="12.66" rx="5.67" ry="5.67"></rect>
              <rect x="508.85" y="434.93" width="90.06" height="12.66" rx="5.67" ry="5.67"></rect>
            </g>
            <path
              ...
              transform="translate(-61.06 -43.49)" fill="url(#b)"></path>
            <path
            ...
            <path
              ...
              fill="#575988"></path>
            <path d="M644.65 649.42l23.73-3.16s-13.44 13.71-23.73 3.16z" opacity=".05"></path>
            <path
              ...
              opacity=".1"></path>
            <path d="M618.56 732.31s-21.28 4-15.24 6.67 16 4.87 16 4.87 6.82.36-.76-11.54z" opacity=".05"></path>
            <g opacity=".05">
              <path
            ...
            <path
              ...
              fill="#ffcdd3"></path>
            <path d="M668.15 381.23l-7.53.77-.84-1.56a6.65 6.65 0 0 1 8.31-1.37z" opacity=".1"></path>
            <path d="M670.05 384.79l-9.93 2.3-.2-1.48-.57-4s3.93-5.24 9.61-1.31l.49 2z" fill="#dce6f2"></path>
            <path
            ...
            <path d="M607.78 406.08s26.82 3.55 29.23-.48M659.94 394.98s14.89 0 18.17 5.61" opacity=".1"></path>
        ...
        {{-- <div class="cta">
          <h2>Like the products we offer?</h2><button class="sc-gsDKAQ owVVI"><a href="/order">Get Started For Free</a></button>
        </div> --}}
      </section>
      {{-- <footer class="sc-jRQBWg iggNUH">
        <div>
          <div class="navItemWithIcon"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
              viewBox="0 0 16 16" class="icon icon-location" height="1em" width="1em"
            ...
            <p>Indonesia, Jakarta Selatan, 12430.</p>
          </div>
          <div class="navItemWithIcon"><svg class="icon icon-email" viewBox="0 0 20 16"
              xmlns="http://www.w3.org/2000/svg">
              <path
            ...
            </svg><a href="mailto:rejamardiansyah11@gmail.com">rejamardiansyah11@gmail.com</a></div>
        </div>
        <ul>
          <li>About Us</li>
          <li>What We Do</li>
        ...
        <ul>
          ...
          <p>© Copyright 2024 MZAR. All rights reserved.</p>
        </small>
      </footer> --}}
      ...
      <footer class="px-4 divide-y dark:bg-gray-100 dark:text-gray-800">
        <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div class="lg:w-1/3">
            <a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
              ...
              <span class="self-center text-2xl font-semibold">MZAR</span>
            </a>
          </div>
        ...
        <div class="py-6 text-sm text-center dark:text-gray-600">© 2024 MZAR.</div>
      </footer>
    </div>
  </div>
  <script src="./MZAR_files/bundle.js.download"></script>
  <script src="./MZAR_files/0.chunk.js.download"></script>
  <script src="./MZAR_files/main.chunk.js.download"></script>
